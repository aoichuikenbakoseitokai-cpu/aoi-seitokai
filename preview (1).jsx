...
const DEMO_OPINIONS_INIT = [
  { row:1, name:"田中 花子", timestamp:"2026/02/18 10:23", message:"体育館のバスケットゴールが壊れていて使えません。早めに修理をお願いします。", status:"採用", progress:"進行中", pct:50, notes:"修繕業者に依頼済み。3月中に完了予定。", reply:"業者に依頼済みです。3月中に修繕完了予定です！", replyImage:null },
  { row:2, name:"佐藤 健太", timestamp:"2026/02/17 15:41", message:"昼休みに図書室を開放してほしいです。勉強したいときに使える場所が少なくて困っています。", status:"採用", progress:"完了", pct:100, notes:"", reply:"毎週月・水・金の昼休みに開放しています。ぜひ利用してください！", replyImage:null },
  { row:3, name:"匿名",      timestamp:"2026/02/16 09:12", message:"給食のメニューにもっとデザートを増やしてほしいです！", status:"未採用", progress:"未着手", pct:0, notes:"", reply:"", replyImage:null },
  { row:4, name:"山本 美咲", timestamp:"2026/02/15 13:55", message:"廊下の電灯がいくつか切れていて暗くて危ないです。特に3階の東側。", status:"未採用", progress:"未着手", pct:0, notes:"", reply:"", replyImage:null },
  { row:5, name:"鈴木 大輔", timestamp:"2026/02/14 08:30", message:"文化祭でやりたい出し物のアンケートを事前にとってほしいです。クラスで話し合う時間をもっとほしい。", status:"未採用", progress:"未着手", pct:0, notes:"", reply:"", replyImage:null },
  { row:6, name:"匿名",      timestamp:"2026/02/12 16:08", message:"校庭の雑草がひどいので清掃活動をしてほしいです。", status:"採用", progress:"進行中", pct:30, notes:"3月の美化活動で対応します。", reply:"", replyImage:null },
];
...
const DEMO_PROGRESS = [
  ["体育館ゴール修繕", 65, "業者手配済み・3月完了予定"],
  ["図書室開放", 100, "毎週月・水・金の昼休みに実施中"],
  ["文化祭企画", 30, "実行委員会を立ち上げ中"],
  ["校内清掃活動", 50, "日程調整中"],
];

const DEMO_EVENTS_INIT = [
  { id:1, date:"2026-03-05", title:"生徒総会",       desc:"全校生徒が体育館に集まって議決を行います" },
  { id:2, date:"2026-03-10", title:"美化活動",        desc:"昼休みに全校で校庭・廊下の清掃を実施" },
  { id:3, date:"2026-03-15", title:"文化祭実行委員会", desc:"第1回 – 放課後 第2会議室" },
  { id:4, date:"2026-03-22", title:"卒業式",          desc:"3年生の卒業をお祝いします" },
  { id:5, date:"2026-04-06", title:"始業式・入学式",   desc:"新年度スタート" },
  { id:6, date:"2026-04-15", title:"生徒会役員選挙",  desc:"新役員を選出します" },
];
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily:FB, background:C.wash, minHeight:"100vh", color:C.ink, lineHeight:1.7 }}>
      ...
      {/* デモバナー */}
      <div style={{ background:"#1e2235", color:"#fff", textAlign:"center", fontFamily:FB, fontSize:11, padding:"6px 16px", letterSpacing:"0.03em" }}>
        🖥️ プレビューモード <span style={{ opacity:0.6 }}>— GAS未接続。デモデータで動作しています。</span>
      </div>
